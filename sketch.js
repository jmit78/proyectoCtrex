...
function setup(){
  ...
  //crear sprite de Trex
   ...
   trex = createSprite(50,160,20,50);
    ...
    suelo.velocityX = -2;
    reset = createSprite(300,100,50,100);
    reset.visible = false ;
    reset.scale = 0.9 /2;
    reset.addImage("reset",reset2);
    gameover = createSprite(355,130,50,100);
...
function cactusspawn(){ 
  ...
  if(frameCount % 130  === 0){
    ...
    cactus_var = createSprite(600,100,40,10);
    switch(cactusrandom){
